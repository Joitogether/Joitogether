    ...
    <n-modal v-model:show="showModal" @mask-click="closeModal">
      ...
      >
        ...
        <div id="target1" class="innerPart_1" v-if="!loading" v-show="currentRef === 1">
          ...
          <div class="flex mt-5 flex-wrap">
            所在地：<n-input v-model:value="user.city" placeholder="你在哪裡呢？" />
          </div>
          <div class="flex mt-5 flex-wrap">
          ...
          <div class="flex mt-5 flex-wrap">
            個性標籤：<n-dynamic-tags v-model:value="tagsArray" :max="6" />
          </div>
        </div>
        <div id="target2" class="innerPart_2" v-show="currentRef === 2">
          ...
          <div class="selfIntro">
            <n-space vertical>
              ...
              <div class="flex mt-5 flex-wrap">
                星座：<n-input placeholder="沒有博愛座喔" v-model:value="user.zodiac" />
              </div>
              <div class="flex mt-5 flex-wrap">
