...
const postList = reactive([
  {
    ...
    content: '天氣很可以的早上👌滿滿的芬多精，吸好吸滿😄好山友👌旅伴🏔攝影咖📷美天氣很可以的早上👌滿滿的芬多精，吸好吸滿😄好山友👌旅伴🏔攝影咖📷美天氣很可以的早上👌滿滿的芬多精，吸好吸滿😄好山友👌旅伴🏔攝影咖📷美天氣很可以的早上👌滿滿的芬多精，吸好吸滿😄好山友👌旅伴🏔攝影咖📷美天氣很可以的早上👌滿滿的芬多精，吸好吸滿😄好山友👌旅伴🏔攝影咖📷美天氣很可以的早上👌滿滿的芬多精，吸好吸滿😄好山友👌旅伴🏔攝影咖📷美食獵人🥗人生好隊友在哪呢？😆完美360度的完美展望👍看山望海）',
    ...
    <div class="post-posts-area ">
      <div v-for="post in postList" :key="post.id" class="post-onepost ">
        ...
        <div class="one-post-bottom mt-2.5  bg-white rounded-2xl pb-4 cursor-pointer">
          <div class="post-bottom-top px-2 pb-3 flex justify-between items-center  border-b-[1px] border-solid border-[rgba(61,57,44,0.1)]">
            <div class="post-bottom-left w-8/12 h-[120px] md:h-[180px]  leading-loose overflow-hidden">
              <div class=" flex justify-between post-onepost-top md:hidden   items-center	cursor-pointer">
                <div class="flex">
              ...
              <p  class="text-sm pt-1 md:pt-2  md:text-[16px] max-h-20 line-clamp-2 ">{{ post.content }}</p>
              <div class="post-bottom-bottom flex leading-loose md:mt-6 ">
                <div class="mr-8">👍🏻 20 讚</div>
                <div>💬  9 留言</div>
              </div>
            </div>
            <div class="post-bottom-right max-w-[120px] md:max-w-[180px] aspect-square rounded-3xl overflow-hidden ">
             <img class="w-full h-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTloBdf4Wa_JxRmW-03mPB_wfP-lBvTGh8-CQ&s" alt="文章照片">
            </div>
          </div>
