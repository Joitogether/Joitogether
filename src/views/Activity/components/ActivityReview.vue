    ...
    <div class="flex justify-center min-w-[400px] items-center min-h-screen bg-gray-200 shadow-2xl">
      ...
      >
        <div id="review" class="m-5 max-w-[768px]">
          ...
          <div class="flex items-center bg-gray-100 border-[1px] border-gray-200 rounded-xl p-3 my-4 text-sm font-semibold">
          ...
          >
            ...
            >
              ...
              <div class="flex flex-col justify-center items-center w-52 px-4 ">
				...
				<p v-else class="flex justify-center text-xs text-gray-400 my-1 w-16">
                  尚未審核
                </p>
                <button
                  @click="handleAttendeeClick(() => toggleApproval(item.id),item.id)"
                  :class="[
                    'flex justify-center items-center w-24 h-14 py-5 border-2 rounded-md text-sm transition-all duration-300',
                    registrationStatus === 'closed'
            ...
            <div class="flex flex-col text-gray-500 my-1 mx-1 px-3 py-2 bg-gray-200 border-[1px] border-gray-200 rounded-xl">
            ...
            <div v-if="item.replies.length" class="flex flex-col bg-yellow-100 p-2 m-1 mt-1 rounded-xl">
