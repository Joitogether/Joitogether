<template>
  <div class="w-full min-h-screen bg-gray-200 flex flex-col gap-4 py-14 px-4 md:px-10 lg:px-40">
    <div class="flex flex-col gap-4">
      ...
      <div class="space-y-4">
        <div class="flex flex-col justify-between px-4 py-4 bg-gray-100 rounded-md md:px-10">
          <div class="flex flex-row gap-3 md:gap-5">
            <div class="w-28 h-28 bg-gray-300 rounded-md shrink-0">
              <img src="" alt="" />
            </div>
            <div class="w-2/3 md:w-full flex flex-col justify-between">
              <div class="">
                ...
                <p class="text-sm text-neutral-800">
                  活動付款內容活動付款內容活動付款內容活動付款內容活動付款內容活動付款內容活動付款內容活動付款內容
                </p>
              </div>
          ...
          <div class="flex flex-row gap-3 md:gap-5">
            ...
            <div class="w-2/3 md:w-full flex flex-col justify-between">
              <div class="">
                <h3 class="text-neutral-950">活動名稱</h3>
                <p class="text-sm text-neutral-800">
                  活動付款內容活動付款內容活動付款內容活動付款內容活動付款內容活動付款內容活動付款內容活動付款內容活動付款內容
                </p>
              </div>
